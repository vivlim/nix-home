{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-2ed21683-afce-4966-9024-82ee0b35dc6d" = [ ];
      ...
      "khotkeys"."{53945f9e-8163-42ad-acb9-81e3267f075e}" = "Meta+Shift+S";
    ...
    files = {
      ...
      "kactivitymanagerdrc"."activities"."2ed21683-afce-4966-9024-82ee0b35dc6d" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "2ed21683-afce-4966-9024-82ee0b35dc6d";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{0aae3f53-8e7d-4fb3-bac9-7e1ce3cd76e7}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{a4ff35d6-937f-404c-942f-78e7838683df}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{90a3cbd4-2ac2-4206-a4c9-58654fdd3348}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{beb7cac2-a3e5-4123-90b1-c855537333ec}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{5baf639a-cc61-42da-b8fe-5bc418ab959a}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{c4e15971-026a-41d8-8a21-3875b0b65972}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{a98f444c-fd1a-44da-a8c9-f619715c8889}";
      ...
      "khotkeysrc"."Data_4_1"."Name" = "Screenclip script";
      "khotkeysrc"."Data_4_1"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_4_1Actions"."ActionsCount" = 1;
      "khotkeysrc"."Data_4_1Actions0"."CommandURL" = "screenclip";
      ...
      "khotkeysrc"."Data_4_1Triggers0"."Key" = "Meta+Shift+S";
      "khotkeysrc"."Data_4_1Triggers0"."Type" = "SHORTCUT";
      "khotkeysrc"."Data_4_1Triggers0"."Uuid" = "{53945f9e-8163-42ad-acb9-81e3267f075e}";
      ...
      "kwinrc"."Desktops"."Id_1" = "32702185-85ce-4afa-853d-26c9845e86c2";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Effect-Wobbly"."Drag" = 92;
      "kwinrc"."Effect-Wobbly"."MoveFactor" = 20;
      "kwinrc"."Effect-Wobbly"."Stiffness" = 3;
      "kwinrc"."Effect-Wobbly"."WobblynessLevel" = 3;
      ...
      "kwinrc"."MouseBindings"."CommandWindow3" = "Activate, raise and pass click";
